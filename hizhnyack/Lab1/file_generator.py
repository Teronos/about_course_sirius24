...
# Читаем шаблон из файла (ниже под ремом про запас лежит этот же шаблон.)
# Возможно лучше хранить шаблон в коде, чтобы в корневом каталоге программы было меньше файлов.
# Но тогда будет сложнее править шаблон.
# А насколько часто это придётся делать?
# ¯\_('')_/¯
